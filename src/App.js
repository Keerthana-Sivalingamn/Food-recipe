  ...
  return (
    <div className="App">
      <div className="subheadline" style={{margin:"15px"}}>
        <h1 style={{fontSize:"2em", fontWeight:"bolder", display:"inline"}}>Food Recipes</h1>
        </div>
      <form onSubmit={getSearch} className="search-form">
        <input placeholder="Enter any dish name (E.g. Smoothie)" className="search-bar" type="text" value={search} onChange={updateSearch} />
